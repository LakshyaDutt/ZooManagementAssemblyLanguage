;PLEASE CHANGE THE LIBRARY PATH TO YOUR OWN LIBRARY PATH, I STORED THE LIBRARY IN MY OWN SYSTEM SOMEWHERE ELSE :-)


%include "/home/kali/Desktop/MalwareAnalysis/Library/libasm_io/joey_lib_io_v9_release.asm"
